...
A query's waiting time is defined as the amount of time that it must wait before its execution starts. In ohter words, if a query is
...
Write a function that return the minimum amount of total waiting time for all of the queries. For example, if you're given the queries of
duration [1, 4, 5], then the total waiting time if the queries were executed in the order of [5, 1, 4] would be
